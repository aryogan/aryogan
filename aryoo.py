...
os.system("xdg-open https://www.facebook.com/aryoganz21?text=Hallo%20Bang%20Ganteng")
# COLORS
x = '\33[m' # DEFAULT
k = '\033[93m' # KUNING +
h = '\x1b[1;92m' # HIJAU +
...
def banner():
	...
	sol().print(cik2)
	ban='''
•   AUTHOR : ARYO-XD WHATSAPP : 085696526470   •
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					cetak(nel(statuscp1, title='ARYO-XD CP'))
				...
				if 'no' in taplikasi:
					...
					cetak(nel(statusok1, title='ARYO-XD OK'))
					ok+=1
					break
					...
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]ARYO XD OK[/bold green]'))
					ok+=1
					break
